...
inline void AnycubicTFTClass::StopPrint()
{
...
void AnycubicTFTClass::HandleSpecialMenu()
{
  ...
  else if (strcasestr(currentTouchscreenSelection, "<PID Tune Ultrabase>") != NULL)
  {
    ...
    queue.inject_P(PSTR("M303 E-1 S60 C8 U1"));
  }
  else if (strcasestr(currentTouchscreenSelection, "<Save EEPROM>") != NULL)
  {
    SERIAL_ECHOLNPGM("Special Menu: Save EEPROM");
...
void AnycubicTFTClass::AnycubicTFT()
{
  if (SpecialMenu)
  {
    switch (filenumber)
    {
    case 0: // Page 1
      ANYCUBIC_SERIAL_PROTOCOLLN("<Exit>");
      ANYCUBIC_SERIAL_PROTOCOLLN("<Exit>");
      ANYCUBIC_SERIAL_PROTOCOLLN("<Preheat Ultrabase>");
      ANYCUBIC_SERIAL_PROTOCOLLN("<Preheat Ultrabase>");
      ANYCUBIC_SERIAL_PROTOCOLLN("<Start Mesh Leveling>");
      ANYCUBIC_SERIAL_PROTOCOLLN("<Start Mesh Leveling>");
      ANYCUBIC_SERIAL_PROTOCOLLN("<Next Mesh Point>");
      ANYCUBIC_SERIAL_PROTOCOLLN("<Next Mesh Point>");
      break;

      case 4: // Page 2
      ANYCUBIC_SERIAL_PROTOCOLLN("<Z Up 0.1>");
      ANYCUBIC_SERIAL_PROTOCOLLN("<Z Up 0.1>");
      ANYCUBIC_SERIAL_PROTOCOLLN("<Z Down 0.1>");
      ANYCUBIC_SERIAL_PROTOCOLLN("<Z Down 0.1>");
      ANYCUBIC_SERIAL_PROTOCOLLN("<Z Up 0.02>");
      ANYCUBIC_SERIAL_PROTOCOLLN("<Z Up 0.02>");
      ANYCUBIC_SERIAL_PROTOCOLLN("<Z Down 0.02>");
      ANYCUBIC_SERIAL_PROTOCOLLN("<Z Down 0.02>");
      break;

      case 8: // Page 3
      ANYCUBIC_SERIAL_PROTOCOLLN("<Fil. Change Pause>");
      ANYCUBIC_SERIAL_PROTOCOLLN("<Fil. Change Pause>");
      ANYCUBIC_SERIAL_PROTOCOLLN("<Fil. Change Resume>");
      ANYCUBIC_SERIAL_PROTOCOLLN("<Fil. Change Resume>");
      ANYCUBIC_SERIAL_PROTOCOLLN("<PID Tune Hotend>");
      ANYCUBIC_SERIAL_PROTOCOLLN("<PID Tune Hotend>");
      ANYCUBIC_SERIAL_PROTOCOLLN("<PID Tune Ultrabase>");
      ANYCUBIC_SERIAL_PROTOCOLLN("<PID Tune Ultrabase>");
      break;

      case 12: // Page 4
      ANYCUBIC_SERIAL_PROTOCOLLN("<Save EEPROM>");
      ANYCUBIC_SERIAL_PROTOCOLLN("<Save EEPROM>");
      ANYCUBIC_SERIAL_PROTOCOLLN("<Load FW Defaults>");
      ANYCUBIC_SERIAL_PROTOCOLLN("<Load FW Defaults>");
      ANYCUBIC_SERIAL_PROTOCOLLN("<Exit>");
      ANYCUBIC_SERIAL_PROTOCOLLN("<Exit>");
      break;
  ...
  else if (card.isMounted())
  {
    ...
    for (count = filenumber; count <= max_files; count++)
    {
      if (count == 0) // Special Entry
      {
        ...
        {
          ANYCUBIC_SERIAL_PROTOCOLLN("<Special Menu>");
          ANYCUBIC_SERIAL_PROTOCOLLN("<Special Menu>");
          SERIAL_ECHO(count);
